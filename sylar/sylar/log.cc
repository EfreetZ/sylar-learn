...
void StdoutLogAppentder::log(std::shared_ptr<Logger> logger,LogLevel::Level level,LogEvent::ptr event) {
    if(level>=m_level){
...
LoggerManager::LoggerManager() {
    ...
    m_root->addAppender(LogAppender::ptr(new StdoutLogAppentder));
