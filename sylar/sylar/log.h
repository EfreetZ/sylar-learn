...
public:
    ...
    LogFormatter(const std::string& patterm);
...
//继承enable_shared_from_this<>才可以获得自己对象的智能指针
public:
...
//输出到控制台的Appender
class StdoutLogAppentder : public LogAppender {
public:
    typedef std::shared_ptr<StdoutLogAppentder> ptr;
