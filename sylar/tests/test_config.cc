...
sylar::ConfigVar<int>::ptr g_int_value_config = sylar::Config::Lookup("systrm.port", (int)8080, "system port");
sylar::ConfigVar<float>::ptr g_float_value_config = sylar::Config::Lookup("systrm.value", (float)10.2f, "system port");
